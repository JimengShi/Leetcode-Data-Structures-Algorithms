...
# We use a container (queue) to keep track of the courses that have no prerequisite, and the size of the container would be bounded by ∣V∣.
...
'''
# Reference: https://www.youtube.com/watch?v=fskPWs3Nuhc&t=591s
...
class Solution:
    def canFinish(self, numCourses: int, prerequisites: List[List[int]]) -> bool:
        ...
        solution_count = 0                          # (2.2) record how many node we already visited
        while queue:
